...
4. Scroll down, add commit message: `Add server.js`
5. Click **"Commit new file"**

---

### Step 5: Add `.gitignore` File

1. Click **"Add file"** → **"Create new file"**
2. **Name**: Type exactly `.gitignore` (with the dot at the beginning)
...
**Check**: Go to https://github.com/Taha-Sana/esp32-cloud-relay
...
3. Connect repository: `Taha-Sana/esp32-cloud-relay`
4. Configure:
```
   Name: esp32-cloud-relay
   Language: Node
   Branch: main
